...
% \subimport{../planning/}{planning.pdf_tex}
...
\IfFileExists{./sessions/sessions_container.tex}{%
  \subimport{sessions/}{sessions_container.tex}
}{%
  \IfFileExists{./sessions/sessions_container.tex.sample}{%
    \subimport{sessions/}{sessions_container.tex.sample}
  }{%
    \message{Pas de fichiers de sessions}
  }
}
